...
import {
  FilteredProductListSecondComponent
} from './components/filtered-product-list-second/filtered-product-list-second.component';
...
} from './components/categories-checkboxlist/categories-checkboxlist.component-module';
import {
  CategoriesSelectionComponentModule
} from './components/categories-selection/categories-selection.component-module';
...
import {
  FilteredProductListSecondComponentModule
} from './components/filtered-product-list-second/filtered-product-list-second.component-module';
import {
  EmployeesSortingFilteringComponentModule
} from './components/employees-sorting-filtering/employees-sorting-filtering.component-module';
import {
  EmployeesSortingFilteringComponent
} from "./components/employees-sorting-filtering/employees-sorting-filtering.component";
